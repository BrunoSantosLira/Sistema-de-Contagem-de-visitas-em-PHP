...
<head>
	...
	<title>Domínios Desativados</title>
...
<body>
		...
		<div class="container mt-5">
			<div class="row">
				...
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item">
						<a class="nav-link active" href="/desativados.php">Domínios Desativados(Lista Negra)</a>
					</li>
					<li class="nav-item">
				...
				<table class="table">
					<h4>Domínios desativados registrados <i class="fa-solid fa-circle" style="color: #ff0a0a;"></i></h4>
						<thead>
							<tr>
							<th scope="col">ID</th>
							<th scope="col">Nome</th>
						...
						<tbody>
							<?php foreach($acessos as $indice  => $dominio) { ?> 
                                <?php if(verificar($dominio['site_id']) == false ) {?>
                                    <tr>
                                    <th scope="row"><?php echo $dominio['site_id'] ?></th>
                                    <td><?php echo $dominio['referrer'] ?></td>
									<td><?php echo $dominio['email'] ?></td>
                                    <td onclick="inserir(<?php echo $dominio['site_id'] ?>)" ><i class="fa-solid fa-upload fa-xl" style="color: #2b932a;"></i></td>
                                    </tr>
                                <?php } ?>
							<?php } ?>
						</tbody>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <p class="text-success">Seu domínio foi movido para a lista de ativos</p>
        </div>
